...
export default function Projects() {
    return (
        <div className='pageWrapper'>
            ...
            <ProjectCard image = {khetibadi} projectTitle ="Khetibadi" techstack ={[flutter, flask]} github="khetibadi" summary="This idea is one little step taken by us with the motive to restore our environment which will have features like step tracking, planting and gifting a tree, calculation of PMI, and eco-friendly alternatives generator for plastic items. It will also consist of randomly generated tasks to do to help the environment become the serene place we envisage."></ProjectCard>
